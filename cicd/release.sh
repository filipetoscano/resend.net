...
gh release create v${VERSION} --message="Release v${VERSION}" \
   -a artifacts/resend-cli-win-x64-${VERSION}.zip

#   -a artifacts/resend-linux-x64-${VERSION}.zip \
#   -a artifacts/resend-osx-x64-${VERSION}.zip
